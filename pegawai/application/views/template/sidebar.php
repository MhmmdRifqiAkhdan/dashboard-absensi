<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="http://localhost/pegawai/" class="brand-link">
    ...
    <div class="sidebar">
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="<?php echo base_url('pegawai/profile') ?>" class="d-block">Muhammad Rifqi Akhdan</a>
            </div>
            <!-- <div class="info">
                <a href="<?php echo base_url('pegawai/about') ?>" class="d-block"> About Me</a>
            </div> -->
        </div>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <!-- <a href="http://localhost/pegawai/" class="nav-link">
